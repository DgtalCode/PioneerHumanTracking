# PioneerHumanTracking - Оглавление

- [Описание проекта](#описание-проекта)
  * [Описание](описание)
  * [Возможные проблемы при текущей реализации проекта:](#возможные-проблемы-при-текущей-реализации-проекта)
...
Для удобства установки всех необходимых пакетов в корне проекта существует специальных файл, хранящий названия нужных библиотек – requirements.txt. Чтобы установить все библиотеки, которые прописаны внутри него, достаточно вызвать следующую команду через командную строку, находясь в папке с проектом:

    pip3 install -r requirements.txt

> В операционной системе Windows чтобы быстро открыть командную строку в папке с проектом, перейдите в нее через проводник, нажмите на поле, где пишется путь и напишите там 
> 
>     cmd
> после чего откроется окно командной строки и можно будет выполнить установку пакетов с помощью указанной ранее команды
